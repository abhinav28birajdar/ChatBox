            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.section}>
                    ...
                    <View style={[styles.card, { backgroundColor: colors.surface }]}>
                        ...
                        <SettingRow icon="language-outline" title="Language" onPress={() => { }} />
                    </View>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <View style={[styles.card, { backgroundColor: colors.surface }]}>
                        ...
                        <SettingRow icon="information-circle-outline" title="About ChatBox" onPress={() => { }} />
                    </View>
                </View>

                <TouchableOpacity style={styles.deleteBtn}>
                    <Text variant="button" color={colors.error}>Delete Account</Text>
                </TouchableOpacity>
